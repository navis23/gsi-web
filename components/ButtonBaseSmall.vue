<template>
    <button class="flex gap-x-1 justify-center items-center bg-sky-600 text-gsi-smokewhite py-1 pl-2 pr-3 rounded-md hover:bg-sky-500 hover:text-gray-100 transition ease-in-out duration-300 font-oswald tracking-wide">
        <slot />
    </button>
</template>
